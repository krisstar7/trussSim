...
class TestSegment(unittest.TestCase):
    ...
    def test_segments_intersection_before_start(self):
        other = Segment(Point(150, 0), Point(0, 200))
        actual = self.segment.intersection_with(other)
        self.assertIsNone(actual)

    def test_segments_intersection_after_end(self):
        other = Segment(Point(200, 0), Point(0, 150))    
        actual = self.segment.intersection_with(other)
        self.assertIsNone(actual)
